...
In the second test case, we can take the subsequence [3,2,10,1]
, its LCM is equal to 30
, which is not contained in a
.

In the third test case, we can take the subsequence [2,3,6,100003]
, its LCM is equal to 600018
, which is not contained in a
.
